...
import { FolderModal } from '@/app/[locale]/workspace/asset-hub/components/FolderModal'
...
import VoiceDesignDialog from '@/app/[locale]/workspace/asset-hub/components/VoiceDesignDialog'
...
export default function AssetHubTab() {
    ...
    const handleVoiceDesignSave = async (voiceId: string, audioBase64: string) => {
        ...
        try {
            ...
            if (res.ok) {
                console.log(t('voiceDesignSaved', { name: voiceDesignCharacter.name }))
            ...
            console.error(t('saveVoiceFailed'))
        }
    }
    ...
    const handleVoiceSelect = async (voice: { id: string; customVoiceUrl: string | null }) => {
        ...
        try {
            ...
            console.error(t('bindVoiceFailed'))
        }
    }
    ...
    const handleDownloadAll = async () => {
        ...
        try {
            ...
            console.error(t('downloadFailed'))
        } finally {
