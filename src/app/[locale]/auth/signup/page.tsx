        ...
        <div className="max-w-md w-full">
          <div className="pin-surface-modal p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-[var(--pin-text-secondary)]">{t('joinPlatform')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="confirmPassword" className="pin-field-label block mb-2">
                  {t('confirmPassword')}
                </label>
                <input
                  id="confirmPassword"
              ...
              {success && (
                <div className="bg-[var(--pin-tone-success-bg)] border border-[color:color-mix(in_srgb,var(--pin-tone-success-fg)_22%,transparent)] text-[var(--pin-tone-success-fg)] px-4 py-3 rounded-lg text-sm">
                  {success}
                </div>
              )}
            ...
            <div className="mt-6 text-center">
              <p className="text-[var(--pin-text-secondary)]">
                {t('hasAccount')}{" "}
                <Link href={{ pathname: '/auth/signin' }} className="text-[var(--pin-tone-info-fg)] hover:underline font-medium">
                  {t('signinNow')}
                </Link>
              </p>
            </div>
