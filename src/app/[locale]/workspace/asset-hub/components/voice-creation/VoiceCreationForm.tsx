    ...
    >
      <div className="flex items-center justify-between px-5 py-3 border-b border-[var(--pin-stroke-base)] bg-[var(--pin-bg-surface-strong)]">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-[var(--pin-text-primary)]">{tHub('addVoice')}</h2>
        </div>
      ...
      <div className="flex border-b border-[var(--pin-stroke-base)]">
      ...
      <div className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
        <div>
          <label className="pin-field-label mb-1 block">{tHub('voiceName')}</label>
          <input
            type="text"
            value={voiceName}
