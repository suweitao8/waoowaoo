...
UE5超写实3D仙侠风格角色设定图，电影级仙侠动画质感，真人动捕级别细节，东方水墨写意美学。

画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。全局光照，体积雾，锐利对焦，8K画质。中间灰背景（RGB 128,128,128），无其他元素。`,
}
...
UE5超写实3D仙侠场景，电影级仙侠动画质感，东方水墨写意美学。

全景构图，360度环绕视角，沉浸式体验。全局光照，体积雾，锐利对焦，8K画质。宽广完整的场景构图，清楚展示主要结构、前景/中景/背景和空间边界。`,
}
...
UE5超写实3D仙侠道具设定图，电影级仙侠质感，东方水墨写意美学。

画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。全局光照，体积雾，锐利对焦，8K画质。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,
}
