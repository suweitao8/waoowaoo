...
日式动漫风格角色设定图，画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。动漫风格人物设计，清晰的线条，鲜艳的色彩。中间灰背景（RGB 128,128,128），无其他元素。`,

  'chinese-comic': `{description}

现代高质量漫画风格角色设定图，画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。细节丰富精致，线条锐利干净，质感饱满，超清2D风格。中间灰背景（RGB 128,128,128），无其他元素。`,

  'japanese-anime': `{description}

现代日系动漫风格角色设定图，画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。赛璐璐上色，清晰干净的线条，视觉小说CG感。中间灰背景（RGB 128,128,128），无其他元素。`,

  'realistic': `{description}

真实电影级画面质感角色设定图，画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。真实电影质感，色彩饱满通透，画面干净精致。中间灰背景（RGB 128,128,128），无其他元素。`,

  'xianxia-3d': `{description}

UE5超写实3D仙侠风格角色设定图，画面横向排列三个视图：正面全身、侧面全身、背面全身，三视图高度一致、比例相同。电影级仙侠动画质感，真人动捕级别细节，东方水墨写意美学，全局光照，体积雾，锐利对焦，8K画质。中间灰背景（RGB 128,128,128），无其他元素。`,
}
...
日式动漫风格场景，全景构图，360度环绕视角，沉浸式体验。宽广完整的场景构图，清楚展示主要结构、前景/中景/背景和空间边界。`,

  'chinese-comic': `{description}

{availableSlots}

现代高质量漫画风格场景，全景构图，360度环绕视角，沉浸式体验。细节丰富精致，线条锐利干净，质感饱满，超清2D风格。`,

  'japanese-anime': `{description}

{availableSlots}

现代日系动漫风格场景，全景构图，360度环绕视角，沉浸式体验。赛璐璐上色，视觉小说CG感。`,

  'realistic': `{description}

{availableSlots}

真实电影级场景，全景构图，360度环绕视角，沉浸式体验。真实电影质感，色彩饱满通透，画面干净精致，真实感。`,

  'xianxia-3d': `{description}

{availableSlots}

UE5超写实3D仙侠场景，全景构图，360度环绕视角，沉浸式体验。电影级仙侠动画质感，东方水墨写意美学，全局光照，体积雾，锐利对焦，8K画质。`,
}

export const STYLE_PROP_TEMPLATES: Record<ArtStyleValue, string> = {
  'american-comic': `{description}

日式动漫风格道具设定图，画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。动漫风格设计，清晰线条，鲜艳色彩。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,

  'chinese-comic': `{description}

现代高质量漫画风格道具设定图，画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。细节丰富精致，线条锐利干净，质感饱满。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,

  'japanese-anime': `{description}

现代日系动漫风格道具设定图，画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。赛璐璐上色，视觉小说CG感。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,

  'realistic': `{description}

真实电影级道具设定图，画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。真实电影质感，色彩饱满通透，画面干净精致。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,

  'xianxia-3d': `{description}

UE5超写实3D仙侠道具设定图，画面横向排列两个视图：前视图、后视图，双视图高度一致、比例相同。电影级仙侠质感，东方水墨写意美学，全局光照，体积雾，锐利对焦，8K画质。中间灰背景（RGB 128,128,128），主体居中完整展示。图片比例16:9横版。`,
}
