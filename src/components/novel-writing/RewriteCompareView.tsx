      ...
      {viewMode === 'side' ? (
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="glass-surface-soft rounded-xl p-4">
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-[var(--glass-stroke-base)]">
          ...
          {/* 改写后 */}
          <div className="glass-surface-soft rounded-xl p-4 ring-2 ring-[var(--glass-color-brand)]/30">
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-[var(--glass-stroke-base)]">
              <h4 className="text-sm font-medium text-[var(--glass-text-primary)]">
                {t('rewrittenText')}
              </h4>
    ...
    if (origLine === rewrLine) {
      ...
      result.push(
        <div key={i} className="flex py-1 text-sm">
          <span className="w-8 text-[var(--glass-text-tertiary)] text-right pr-2 select-none">
            {i + 1}
          </span>
          <span className="flex-1 text-[var(--glass-text-secondary)]">
            {origLine}
          </span>
        </div>
      )
