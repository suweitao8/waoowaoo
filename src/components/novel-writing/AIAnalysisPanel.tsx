    ...
    <div className="flex-1 pin-surface-soft rounded-xl p-6 overflow-y-auto max-h-[calc(100vh-200px)]">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {/* 标签页切换 */}
          <div className="flex items-center gap-1 p-1 rounded-lg bg-[var(--pin-bg-muted)]">
            <button
              onClick={() => setActiveTab('project')}
              className={`px-3 py-1 text-sm rounded-md transition-colors ${
                activeTab === 'project'
                  ? 'bg-[var(--pin-bg-surface)] text-[var(--pin-text-primary)]'
                  : 'text-[var(--pin-text-secondary)] hover:text-[var(--pin-text-primary)]'
              }`}
            >
              {t('projectSummary')}
            </button>
          ...
          <>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="pin-textarea-base w-full px-3 py-2 min-h-[120px]"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="pin-textarea-base w-full px-3 py-2 min-h-[80px]"
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {characters.map((char, index) => (
                        <div
                          key={index}
                          className="p-3 rounded-lg border border-[var(--pin-stroke-base)] bg-[var(--pin-bg-muted)]"
                        >
                          <div className="font-medium text-[var(--pin-text-primary)] mb-1">
                            {char.name}
                          </div>
                          {char.description && (
            ...
            {!hasAnalysis && !isAnalyzing && (
              <div className="text-center py-12">
                <AppIcon name="sparkles" className="w-16 h-16 text-[var(--pin-text-tertiary)] mx-auto mb-4" />
                <p className="text-[var(--pin-text-secondary)] mb-4">
        ...
        {activeTab === 'chapters' && (
          <div className="space-y-4">
            {analyzedChapters.length === 0 ? (
              <div className="text-center py-12">
                <AppIcon name="bookOpen" className="w-16 h-16 text-[var(--pin-text-tertiary)] mx-auto mb-4" />
              ...
              analyzedChapters.map((chapter) => {
                ...
                return (
                  <div
                    key={chapter.id}
                    className="p-4 rounded-lg border border-[var(--pin-stroke-base)] bg-[var(--pin-bg-muted)]"
                  >
                    <h3 className="font-medium text-[var(--pin-text-primary)] mb-3">
                      {chapter.name}
                    </h3>

                    {worldContextData && (
                      <div className="mb-3">
                        <div className="text-xs text-[var(--pin-text-tertiary)] mb-1">世界观</div>
                        <div className="text-sm text-[var(--pin-text-secondary)]">
                    ...
                    {writingStyleData && (
                      <div>
                        <div className="text-xs text-[var(--pin-text-tertiary)] mb-1">写作风格</div>
                        <div className="text-sm text-[var(--pin-text-secondary)]">
