    ...
    <div className="flex-1 glass-surface-soft rounded-xl p-6 overflow-y-auto max-h-[calc(100vh-200px)]">
      <div className="max-w-4xl mx-auto">
        ...
        {(worldContext || writingStyle || characters.length > 0) && (
          <div className="mb-6 p-4 rounded-xl border border-[var(--glass-stroke-base)] bg-[var(--glass-bg-muted)]">
            ...
            <div className="space-y-2 text-sm">
              {worldContext && (
                <div>
                  <span className="text-[var(--glass-text-tertiary)]">世界观：</span>
              ...
              {writingStyle && (
                <div>
                  <span className="text-[var(--glass-text-tertiary)]">写作风格：</span>
                  <span className="text-[var(--glass-text-secondary)]">{writingStyle}</span>
                </div>
              )}
              {characters.length > 0 && (
                <div>
                  <span className="text-[var(--glass-text-tertiary)]">角色：</span>
                  <span className="text-[var(--glass-text-secondary)]">
        ...
        {rewriteResult ? (
          ...
          <>
            ...
            <div className="mb-6">
              ...
              <div className="glass-textarea-base w-full px-3 py-2 min-h-[120px] max-h-[200px] overflow-y-auto">
                {novelText ? (
                  <div className="text-sm text-[var(--glass-text-secondary)] whitespace-pre-wrap">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs rounded-lg transition-colors ${
                      instruction === preset.value
                        ...
                        : 'bg-[var(--glass-bg-muted)] text-[var(--glass-text-secondary)] hover:bg-[var(--glass-bg-fog)]'
                    }`}
                  >
                    {preset.label}
                  </button>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="glass-btn-base glass-btn-primary px-6 py-2 text-sm disabled:opacity-50"
              >
                {isRewriting ? (
                  <>
