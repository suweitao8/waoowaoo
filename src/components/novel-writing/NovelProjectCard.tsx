  ...
  return (
    ...
    >
      ...
      <div className="p-5 relative z-10">
        {/* 标题 */}
        <h3 className="text-lg font-bold text-[var(--glass-text-primary)] mb-2 line-clamp-2 group-hover:text-[var(--glass-tone-info-fg)] transition-colors">
          {name}
        </h3>

        {/* 描述 */}
        {description && (
          <p className="text-sm text-[var(--glass-text-secondary)] line-clamp-2 mb-4">
            {description}
          </p>
        )}
        ...
        <div className="flex items-center gap-4 mb-3 text-sm">
          <span className="flex items-center gap-1 text-[var(--glass-text-secondary)]">
