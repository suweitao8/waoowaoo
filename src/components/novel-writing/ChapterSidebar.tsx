...
export default function ChapterSidebar({
  ...
  return (
    <div
      className="w-64 flex-shrink-0 glass-surface-soft rounded-xl p-4 h-[calc(100vh-200px)] flex flex-col"
    ...
    >
            ...
            >
              <div className="flex items-center gap-2">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-[var(--glass-text-tertiary)] mt-0.5 flex items-center gap-2">
                ...
                {isSelected && selectedChapterIds.length > 1 && (
                  <div className="w-5 h-5 rounded bg-[var(--glass-color-brand)] text-white text-xs flex items-center justify-center">
                    ✓
                  </div>
                )}
              </div>
      ...
      {/* 底部操作 */}
      <div className="pt-4 border-t border-[var(--glass-stroke-base)] space-y-2">
        <button
          onClick={onNewChapter}
          className="w-full glass-btn-base glass-btn-secondary px-3 py-2 text-sm flex items-center justify-center gap-2"
        >
        ...
        {onSummarize && (
          <button
            onClick={onSummarize}
            className="w-full glass-btn-base glass-btn-primary px-3 py-2 text-sm flex items-center justify-center gap-2"
          >
